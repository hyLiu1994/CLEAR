...
from vista.src.modules.M8_AnomalyDetection import handle_task_exception_with_retry
from vista.src.modules.M9_Deredundancy import deredundancy
...
class KnowledgeUnitManager:
    ...
    def load_knowledge_unit_list(self, start_point: int):
        ...
        logging.info(f"load_knowledge_unit_list file_path:{file_path}")
